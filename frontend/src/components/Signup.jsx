...
const Signup = (  {API_URL= "https://expense-tracker-backend-4lhs.onrender.com", onSignup}) => {
    ...
    const fetchProfile = async (token) => {
     ...
     const persistAuth = (profile, token) => {
        ...
        // to validate all fieldsa are filled by user or not
    const validateForm = () => {
        const newErrors = {};
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            ...
            if (typeof onSignup === "function") {
                try {
                    // onSignup(profile, rememberMe, token);///////////////////////////////////////////////////////////////changes it
                    onSignup({
                        userData: profile,
                        remember: rememberMe,
                        tokenFromApi: token
                    });  // ✅ Correct: passing as an object
                    navigate("/");
           ...
           <form onSubmit={handleSubmit} noValidate > 
            ...
            <div className='mb-6' >
                ...
                <div className={signupStyles.inputContainer}>
                    ...
                    errors.name ? "border-red-300" : "border-gray-200"}`} placeholder='name' />
                </div>
                ...
                {errors.name &&  (
                    <p className={signupStyles.fieldError}>
                      ...
                      <div className='mb-6' >
                          ...
                          <div className={signupStyles.inputContainer}>
                              ...
                              <input type="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)}
                                  className={`${signupStyles.input} ${errors.email ? "border-red-300" : "border-gray-200"}`} placeholder='yours@example.com' />
                          </div>
                      ...
                      <div className='mb-6' >
                          ...
                          <div className={signupStyles.inputContainer}>
                              ...
                              <input type="password" id="password" value={password} onChange={(e) => setPassword(e.target.value)}
                                  className={`${signupStyles.input} ${errors.password ? "border-red-300" : "border-gray-200"}`} placeholder='Enter your password' />
                      ...
                      <button  type='submit' className={`${signupStyles.button} ${isLoading ? signupStyles.buttonDisabled : ""}`}
                       disabled={isLoading} >
