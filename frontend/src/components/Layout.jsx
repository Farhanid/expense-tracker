...
import { Home, Utensils, Car, ShoppingCart, Gift, Zap, Activity, ArrowUp, CreditCard, PiggyBank, DollarSign, TrendingUp, Clock, RefreshCcw, Info, ChevronUp, ChevronDown, PieChart } from 'lucide-react'
import axios from 'axios'
import { Outlet } from 'react-router-dom'


const API_BASE = 'https://expense-tracker-backend-4lhs.onrender.com/api'
...
const Layout = ({ onLogout, user}) => {
  ...
  const fetchTransactions = async () => {
   ...
   //to add transcation either income or expense 
  ...
  // to edit the transcation either income or expense
  ...
  const editTransaction = async (id, transaction) => {
   ...
   // to delete the transcation either income or expense
 ...
 //gets stats data according to time 
  const stats = useMemo(() => {
    const now = new Date();
          ...
          <div className={styles.layout.mainContainer(sidebarCollapsed)} >
               <div className={styles.header.container} >
                   <div   >
                        ...
                        <p className={styles.header.subtitle} >Welcome back
                  ...
                  <div className={styles.grid.rightColumn} >
                    ...
                    <div className={styles.cards.base} >
                       ...
                       <div className={styles.transactions.dataStackingInfo} >
                          ...
                          <span>
                            Transcations are stacked by date (newest first)
                          </span>
                       </div>
                       ...
                       <div className={styles.transactions.listContainer} >
                            ...
                            const { id, description, amount, date, category, type} = transcation;
                            return (
                  ...
                  <div className={styles.transactions.viewAllContainer} >
                    ...
                    className={styles.transactions.viewAllButton} >
                      ...
                      {showAllTransactions ?  (
                        ...
                        View Transcation All ({transactions.length})
                        </>
                      )}
